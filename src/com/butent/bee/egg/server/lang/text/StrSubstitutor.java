 ...
 * @author Oliver Heger
 * @version $Id: StrSubstitutor.java 902944 2010-01-25 19:32:08Z sebb $
 * @since 2.2
 */
public class StrSubstitutor {
  ...
  /**
   * Replaces all the occurrences of variables in the given source object with
   * their matching values from the map. This method allows to specifiy a custom
  ...
  public static String replaceSystemProperties(Object source) {
    return new StrSubstitutor(StrLookup.systemPropertiesLookup())
        .replace(source);
  }

  // -----------------------------------------------------------------------
  /**
   * Creates a new instance with defaults for variable prefix and suffix and the
   * escaping character.
   */
   ...
   *           if the prefix or suffix is null
   */
  public <V> StrSubstitutor(Map<String, V> valueMap, String prefix,
      String suffix) {
   ...
   *           if the prefix or suffix is null
   */
  public StrSubstitutor(StrLookup<?> variableResolver, String prefix,
      String suffix, char escape) {
   ...
   */
  public StrSubstitutor(StrLookup<?> variableResolver,
      StrMatcher prefixMatcher, StrMatcher suffixMatcher, char escape) {
    this.setVariableResolver(variableResolver);
   ...
   * the resolver using the given source string as a template.
   * <p>
   * Only the specified portion of the string will be processed. The rest of the
   * string is not processed, and is not returned.
   * 
   * @param source
   *          the string to replace in, null returns null
   * @param offset
   ...
   * altered by this method.
   * <p>
   * Only the specified portion of the array will be processed. The rest of the
   * array is not processed, and is not returned.
   * 
   * @param source
   *          the character array to replace in, not altered, null returns null
   * @param offset
  ...
  /**
   * Replaces all the occurrences of variables with their matching values from
   * the resolver using the given source buffer as a template. The buffer is not
   * altered by this method.
   * 
   * @param source
   ...
   * altered by this method.
   * <p>
   * Only the specified portion of the buffer will be processed. The rest of the
   * buffer is not processed, and is not returned.
   * 
   * @param source
   *          the buffer to use as a template, not changed, null returns null
   * @param offset
   ...
   * <p>
   * Only the specified portion of the buffer will be processed. The rest of the
   * buffer is not processed, but it is not deleted.
   * 
   * @param source
   *          the buffer to replace in, updated, null returns zero
   * @param offset
   ...
   *         occurred.
   */
  private int substitute(StrBuilder buf, int offset, int length,
        ...
        if (pos > offset && chars[pos - 1] == escape) {
          ...
          while (pos < bufEnd) {
            ...
            if (endMatchLen == 0) {
              ...
              String varName = new String(chars, startPos + startMatchLen, pos
   ...
   */
  private void checkCyclicSubstitution(String varName,
      List<String> priorVariables) {
   ...
   * each substitution occurs. The method is passed the variable's name and must
   * return the corresponding value. This implementation uses the
   ...
   */
  protected String resolveVariable(String variableName, StrBuilder buf,
   ...
   * <p>
   * The variable suffix is the characer or characters that identify the end of
   * a variable. This suffix is expressed in terms of a matcher allowing
   ...
   * <p>
   * The variable suffix is the characer or characters that identify the end of
   * a variable. This method allows a single character suffix to be easily set.
   * 
   * @param suffix
   ...
   * <p>
   * The variable suffix is the characer or characters that identify the end of
   * a variable. This method allows a string suffix to be easily set.
   * 
   * @param suffix
   *          the suffix for variables, not null
   * @return this, to enable chaining
