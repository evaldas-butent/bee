...
public final class SqlConstants {
  ...
  public enum SqlFunction {
    BITAND, IF, CASE, CAST, NVL, CONCAT,
  ...
  public enum SqlKeyword {
    DB_NAME, DB_SCHEMA,
    DB_SCHEMAS, DB_TABLES, DB_FIELDS, DB_KEYS, DB_FOREIGNKEYS, DB_INDEXES, DB_TRIGGERS,
    RENAME_TABLE, DROP_TABLE, DROP_FOREIGNKEY, SET_PARAMETER,
    CREATE_SCHEMA, CREATE_INDEX, CREATE_TRIGGER,
    ADD_CONSTRAINT, PRIMARY_KEY, FOREIGN_KEY, DELETE, SET_NULL, LIKE,
