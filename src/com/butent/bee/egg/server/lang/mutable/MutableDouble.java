 ...
 * @version $Id: MutableDouble.java 916081 2010-02-25 01:28:13Z niallp $
 */
public class MutableDouble extends Number implements Comparable<MutableDouble>,
   ...
   * is a <code>Double</code> object that represents a double that has the
   * identical bit pattern to the bit pattern of the double represented by this
   * object. For this purpose, two <code>double</code> values are considered to
   * be the same if and only if the method
