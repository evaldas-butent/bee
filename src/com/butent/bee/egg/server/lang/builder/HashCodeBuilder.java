...
public class HashCodeBuilder implements Builder<Integer> {
   ...
   * numbers are preferred, especially for the multiplier.
   * </p>
   * 
   ...
   * to and including the specified superclass. A null superclass is treated as
   * java.lang.Object.
   * </p>
   * 
   * <p>
   ...
   *          <code>null</code>
   * @param excludeFields
   *          array of field names to exclude from use in calculation of hash
   *          code
   * @return int hash code
   * @throws IllegalArgumentException
   *           if the Object is <code>null</code>
   ...
   * for <code>java.lang.Boolean</code> instances that represent
   * <code>true</code> or <code>1237</code> for <code>java.lang.Boolean</code>
   * instances that represent <code>false</code>.
   * </p>
   * <p>
