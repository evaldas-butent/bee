...
/**
 * Creates an ExtendedProperty with specified {@code name}, {@code sub} and
 * {@code value} values. 
 * @param name the {@code name} to set for the ExtendedProperty
...
/**
 * Creates an ExtendedProperty from another specified ExtendedProperty {@code sp}.
 * Name, Sub and Value are copied from {@code sp}.
...
/**
 * @return a String representation of the current ExtendedProperty. Name is 
 * separated with a default value separator "=", Sub by a default property
 * separator ".".
 * <p> E.g An ExtendedProperty with {@code Name}, {@code Sub} and {@code Value}
 * set would be represented as: {@code Name.Sub=Value}</p>
 */
  @Override
