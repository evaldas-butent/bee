...
public class H4 extends FertileNode {
  ...
  public H4 setCSSClass(String value) {
  ...
  public H4 setTitle(String value) {
  ...
  public H4 setStyle(String value) {
  ...
  public H4 setLang(String value) {
