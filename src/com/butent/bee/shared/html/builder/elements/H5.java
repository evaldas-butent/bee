...
public class H5 extends FertileNode {
  ...
  public H5 setCSSClass(String value) {
  ...
  public H5 setTitle(String value) {
  ...
  public H5 setStyle(String value) {
  ...
  public H5 setLang(String value) {
