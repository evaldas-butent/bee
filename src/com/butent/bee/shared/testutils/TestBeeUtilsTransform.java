...
public class TestBeeUtilsTransform extends TestCase implements ILogger {
	...
	private final boolean  BOOL_ALLOW_LOGGING = false;
	...
	public void testTransformObject() {
		...
		assertEquals("0", BeeUtils.transform( (Object) (int) 0));
	...
	public void testTransformEnumeration(){
		...
		assertEquals("BLOB_BOOLEAN_INT_CHAR_STRING_DOUBLE_This_is_a_test_end line", BeeUtils.transformEnumeration(testc4.elements(), "_"));
		assertEquals("BLOB, BOOLEAN, INT, CHAR, STRING, DOUBLE, This, is, a, test, end line", BeeUtils.transformEnumeration(testc4.elements()));
		assertEquals("BLOB, BOOLEAN, INT, CHAR:STRING, DOUBLE:This:is:a:test_end line", BeeUtils.transformEnumeration(testc4.elements(), "_",":",null));
	...
	public void testTransformMap(){
		...
		assertEquals("1=1=1=BLOB_2=BOOLEAN_3=INT_4=CHAR_2=1=STRING_2=DOUBLE_3=This_4=is_5=a_6=test_2=end line", BeeUtils.transformMap(testc4, "_"));
		assertEquals("1=1=1=BLOB, 2=BOOLEAN, 3=INT, 4=CHAR, 2=1=STRING, 2=DOUBLE, 3=This, 4=is, 5=a, 6=test, 2=end line", BeeUtils.transformMap(testc4));
		assertEquals("1=1=1=BLOB, 2=BOOLEAN, 3=INT, 4=CHAR:2=1=STRING, 2=DOUBLE:3=This:4=is:5=a:6=test_2=end line", BeeUtils.transformMap(testc4, "_",":",null));
	...
	public void testTransformCollection(){
		...
		assertEquals("BLOB_BOOLEAN_INT_CHAR_STRING_DOUBLE_This_is_a_test_end line", BeeUtils.transformCollection(testc4, "_"));
		assertEquals("BLOB, BOOLEAN, INT, CHAR, STRING, DOUBLE, This, is, a, test, end line", BeeUtils.transformCollection(testc4));
		assertEquals("BLOB, BOOLEAN, INT, CHAR:STRING, DOUBLE:This:is:a:test_end line", BeeUtils.transformCollection(testc4, "_",":",null));
	...
	{	
		...
		assertEquals (5, beeUtils.length(obj));	
	}
	...
	public void testCompare(){
		...
		assertEquals(true, beeUtils.compare((Object)null, (Object)5)<0);
		assertEquals(true, beeUtils.compare((Object)5, (Object)null)>0);
	...
	public void testContextCollection()
	{
		...
		assertEquals(true, beeUtils.context("text", (Collection<CharSequence>)testc1));
		assertEquals(true, beeUtils.context("text2", (Collection<CharSequence>)testc1));
		assertEquals(false, beeUtils.context("texx", (Collection<CharSequence>)testc1));
		assertEquals(false, beeUtils.context("", (Collection<CharSequence>)testc1));
		assertEquals(false, beeUtils.context("text", (Collection<CharSequence>)testc2));
	}
	...
	public void testGetContext()
	{
		...
		assertEquals(rez1, beeUtils.getContext("text", (Collection<CharSequence>)testc1));
		assertEquals(rez2, beeUtils.getContext("text2", (Collection<CharSequence>)testc1));
		assertEquals(rez3, beeUtils.getContext("texx", (Collection<CharSequence>)testc1));
		assertEquals(rez3, beeUtils.getContext("", (Collection<CharSequence>)testc1));
		assertEquals(testc2, beeUtils.getContext("text", (Collection<CharSequence>)testc2));
	}
	...
	public void testInsertCS(){
		...
		assertEquals("This is a test and it works", beeUtils.insert("This is a test", 14, " and it works"));
	}
	...
	public void testLimit(){
		...
		assertEquals(Double.POSITIVE_INFINITY, beeUtils.limit(Double.MAX_VALUE*5, Double.MAX_VALUE*5, Double.MAX_VALUE*5));
		assertEquals(5.0, beeUtils.limit(5.0, (double)1, (double)15));
    ...
    public void testZero()
    {
    	...
    	assertEquals (0, beeUtils.zero((Object)(int) 15));
    	assertEquals ((long) 0, beeUtils.zero((Object)(long) 5));
    	...
    	assertEquals ((double)0.0, beeUtils.zero((Object)(double) 0.5E-3));
    ...
    public void testToString()
    {
    	...
    	assertEquals("1.2", beeUtils.toString((double) 1.2));
    	assertEquals("5", beeUtils.toString((int) 5));
