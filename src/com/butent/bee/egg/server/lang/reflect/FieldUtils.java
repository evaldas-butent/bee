...
public class FieldUtils {
   ...
   * @param forceAccess
   *          whether to break scope restrictions using the
   *          <code>setAccessible</code> method. False will only match public
   *          fields.
   * @return the Field object
   * @throws IllegalArgumentException
   *           if the class or field name is null
  ...
  /**
   * Read the named public field. Only the class of the specified object will be
   * considered.
   * 
   * @param target
   *          the object to reflect, must not be null
  ...
  /**
   * <p<>Gets a Field value by name. Only the class of the specified object will
   * be considered.
   * 
   * @param target
   *          the object to reflect, must not be null
