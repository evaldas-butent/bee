...
public class TestPropertyUtils {
	...
	public final void testAddChildren() {
		...
		assertEquals (2, PropertyUtils.addChildren(propExtColl, "name2", "sub1", "value1","sub2", "value2"));
		...
		assertEquals (2, PropertyUtils.addChildren(propExtColl, "name2", null, "value1","sub2", "value2"));
	...
	public final void testAddPropertiesCollectionOfExtendedPropertyBooleanObjectArray() {
		...
		assertEquals (2, PropertyUtils.addProperties(propExtColl, false, "name1", "value1", "name2", "value2"));
		assertEquals (1, PropertyUtils.addProperties(propExtColl, true, "name1", "sub1", "value1"));
		assertEquals (2, PropertyUtils.addProperties(propExtColl, true, "name1", "sub1", "value1", "name2", "sub1", "value2"));
		...
		assertEquals (3, PropertyUtils.addProperties(propExtColl, false, "name1", "value1", "name2", "value2", "name3", 2, 1, "value2"));
		assertEquals (2, PropertyUtils.addProperties(propExtColl, false, "name1", "value1", null, null, "name3", 2, 1, "value2"));
		assertEquals (2, PropertyUtils.addProperties(propExtColl, false, "name1", "value1", "name2", null, "name3", 2, 1, "value2"));

		try
		{		
			assertEquals (2, PropertyUtils.addProperties(propExtColl1, false, "name1", "value1", "name2", null, "name3", 2, 1, "value2"));
			fail ("BeeRuntimeException not works");
		}
		catch (BeeRuntimeException e)
		{
	...
	public final void testAddProperty() {
		...
		try
		{		
			assertEquals(false, PropertyUtils.addProperty(propList2, "name1", "value1")); //propList 2 = null
			fail ("BeeRuntimeException not works");
		}
		catch (BeeRuntimeException e)
		{
	...
	public final void testAddSplit() {
		...
		assertEquals (4, PropertyUtils.addSplit(propExtColl, "name1", "sub1", "value1,value2,value3", null));
	}
	...
	public final void testCreatePropertiesObjectArray() {
		...
		assertEquals(expected1[i].toString(), PropertyUtils.createProperties("NAME1","VALUE1","NAME2").toArray()[i].toString());
		
		for (int i = 0; i < expected2.length; i++)
		assertEquals(expected2[i].toString(), PropertyUtils.createProperties("NAME1","VALUE1","NAME2","VALUE2").toArray()[i].toString());
	...
	public final void testCreatePropertiesStringStringArray() {
		...
		for (int i = 0; i < expected1.length; i++)
		assertEquals(expected1[i].toString(), PropertyUtils.createProperties("AA:", mas).toArray()[i].toString());
		
		for (int i = 0; i < expected2.length; i++)
		assertEquals(expected2[i].toString(), PropertyUtils.createProperties(null, mas).toArray()[i].toString());
		
	}

	@Test
	public final void testExtendedToArray() {
        String[][] mas = {{"NAME1", "SUB1", "VALUE1", "10:13:08.227"}, {"NAME2","SUB2","VALUE2", "10:13:08.227"}, {"NAME3","SUB3","VALUE3", "10:13:08.446"}};
	...
	public final void testTransformStringString()
	{
		...
		try {
            ...
            {
            	if (m[i].toString().equals("private static java.lang.String com.butent.bee.shared.utils.PropertyUtils.transformString(java.lang.String)"))
            	{
            		index = i;
            	}
            }
         ...
         try {
             ...
             Class partypes[] = new Class[1];
              ...
              Method meth = m[index];//cls.getMethod("private static java.lang.String transformString", partypes);
              ...
              assertEquals("abc", (String) meth.invoke(null, arglist));
              arglist[0]= new String("");
              assertEquals("", (String) meth.invoke(null, arglist));
              arglist[0]= new String("1F");
              assertEquals("1F", (String) meth.invoke(null, arglist));
              arglist[0]= new String("   1F");
              assertEquals("   1F", (String) meth.invoke(null, arglist));
              
              arglist[0]= new String(" ");
              assertEquals("[hex] 0020", (String) meth.invoke(null, arglist));
              
              arglist[0]= new String("  ");
              assertEquals("[hex] 00200020", (String) meth.invoke(null, arglist));
              
              arglist[0]= new String("                ");
              assertEquals("[whitespace] 16", (String) meth.invoke(null, arglist));     
           }
           catch (Exception e) {
              e.printStackTrace();
           }
