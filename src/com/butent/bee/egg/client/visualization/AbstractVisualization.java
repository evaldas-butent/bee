...
public abstract class AbstractVisualization<E extends AbstractDrawOptions> extends Composite {
  ...
  public static final native void registerVisualization(String name, VisualizationFactory factory) /*-{
    $wnd[name] = function(container) {
      this.gwt_vis = @com.butent.bee.egg.client.visualization.AbstractVisualization::createVisualization(Lcom/butent/bee/egg/client/visualization/AbstractVisualization$VisualizationFactory;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/user/client/Element;)(factory, this, container);
    }
// TODO gwt compiler warning
//    $wnd[name].prototype.draw = function(data, options) {
//      this.gwt_vis.@com.butent.bee.egg.client.visualization.AbstractVisualization::draw(Lcom/butent/bee/egg/client/visualization/AbstractDataTable;Lcom/google/gwt/visualization/client/AbstractDrawOptions;)(data, options);
//    }
  }-*/;
  ...
  private static native void registerSelectFunctions(JavaScriptObject jso) /*-{
    jso.getSelection = function() {
      return this.gwt_vis.@com.butent.bee.egg.client.visualization.Selectable::getSelections()();
    }
    jso.setSelection = function(selection) {
      this.gwt_vis.@com.butent.bee.egg.client.visualization.Selectable::setSelections(Lcom/google/gwt/core/client/JsArray;)(selection);
    }
  }-*/;
