...
/**
 * <p>
 * <code>Range</code> represents an immutable range of numbers of the same type.
 * </p>
 * <p>
 * The objects need to either be implementations of
 * <code>java.lang.Comparable</code> or you need to supply a
...
public final class Range<T> implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>Range</code> using the specified element as both the
   * minimum and maximum in this range.
   * </p>
   * <p>
   ...
   * 
   * @param element
   *          the value to use for this range, must not be <code>null</code>
   * @return the new range object
   * @throws IllegalArgumentException
   *           if the value is <code>null</code>
   * @throws ClassCastException
   *           if the value is not Comparable
   */
  ...
  /**
   * <p>
   * Constructs a new <code>Range</code> with the specified minimum and maximum
   ...
   * 
   * @param element1
   *          first value that defines the edge of the range, inclusive
   * @param element2
   ...
   * @throws ClassCastException
   *           if either value is not Comparable
   */
   ...
   * </p>
   * <p>
   * The range uses the passed in <code>Comparator</code> to determine where
   * values lie in the range.
   * </p>
   * 
   * @param element
  ...
  private Range(T element1, T element2, Comparator<T> c) {
    if (element1 == null || element2 == null) {
      throw new IllegalArgumentException(
          "Elements in a range must not be null: element1=" + element1
              + ", element2=" + element2);
    }
  ...
  /**
   * <p>
   * Whether or not the Range is using the default natural comparison method to
   * compare elements.
   * </p>
   * 
   ...
   * <code>-1</code> if the element is before the range, <code>0</code> if
   * contained within the range and <code>1</code> if the element is after the
   * range.
   * </p>
   * 
   * @param element
  ...
  public boolean overlapsRange(Range<T> range) {
    ...
    return range.contains(this.minimum) || range.contains(this.maximum)
  ...
  private static class ComparableComparator<E extends Comparable<? super E>>
    ...
    // Comparator works for all types
