 ...
 * @author Gary Gregory
 * @since 2.0
 * @version $Id: BitField.java 889215 2009-12-10 11:56:38Z bayard $
 */
public class BitField {
   ...
   * 
   * @param mask
   *          the mask specifying which bits apply to this BitField. Bits that
   ...
   * in a multi-bit set must be set for this method to return <code>true</code>.
   * </p>
   * 
   * @param holder
   *          the int data containing the bits we're interested in
