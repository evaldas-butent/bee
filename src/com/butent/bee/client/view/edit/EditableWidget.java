...
public class EditableWidget implements KeyDownHandler, BlurHandler, EditStopEvent.Handler {
  ...
  public void openEditor(HasWidgets editorContainer, Element sourceElement,
    ...
    String oldValue = (row == null) ? null : row.getString(getDataIndex());
  ...
  private boolean validate(String oldValue, String newValue) {
    ...
    if (getValidation() != null) {
      getValidation().update(getRowValue(), BeeConst.UNDEF, getDataIndex(),
