...
public class SystemUtils {
   ...
   * 
   * <p>
   * Defaults to <code>null</code> if the runtime does not have security access
  ...
  /**
   * <p>
   * The <code>java.ext.dirs</code> System Property. Path of extension directory
   * or directories.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * The <code>java.library.path</code> System Property. List of paths to search
  ...
  /**
   * <p>
   * The <code>java.vm.specification.vendor</code> System Property. Java Virtual
   ...
   * User's country code, such as <code>GB</code>. First in Java version 1.2 as
   * <code>user.region</code>. Renamed to <code>user.country</code> in 1.4
   * </p>
   * 
   * <p>
   * Defaults to <code>null</code> if the runtime does not have security access
  ...
  /**
   * <p>
   * The <code>user.language</code> System Property. User's language code, such
   * as <code>"en"</code>.
   * </p>
   * 
   * <p>
   ...
   *           <code>checkPropertyAccess</code> method doesn't allow access to
  ...
  private static float getJavaVersionAsFloat() {
    return toVersionFloat(toJavaVersionIntArray(SystemUtils.JAVA_VERSION,
  ...
  public static boolean isJavaAwtHeadless() {
    return JAVA_AWT_HEADLESS != null ? JAVA_AWT_HEADLESS.equals(Boolean.TRUE
        .toString()) : false;
  }
  ...
  /**
   * <p>
   * Converts the given Java version string to an <code>int[]</code> of maximum
   * size <code>3</code>.
   * </p>
   * 
   * <p>
