...
public class DurationFormatUtils {
   ...
   * </p>
   * 
   * @see com.butent.bee.egg.server.lang.time.FastDateFormat
  ...
  public static String formatDurationWords(long durationMillis,
      boolean suppressLeadingZeroElements, boolean suppressTrailingZeroElements) {
  ...
  public static String formatPeriodISO(long startMillis, long endMillis) {
    return formatPeriod(startMillis, endMillis, ISO_EXTENDED_FORMAT_PATTERN,
   ...
   * by choosing January->February = 1 month and then calculating days forwards,
   * and not the 1 month and 26 days gained by choosing March -> February = 1
   ...
   */
  static String format(Token[] tokens, int years, int months, int days,
      ...
      if (value instanceof StringBuffer) {
        ...
        if (value == y) {
          ...
          if (lastOutputSeconds) {
            milliseconds += 1000;
            String str = padWithZeros ? StringUtils.leftPad(
  ...
  static class Token {
    ...
    /**
     * Returns a hashcode for the token equal to the hashcode for the token's
     * value. Thus 'TT' and 'TTTT' will have the same hashcode.
     * 
