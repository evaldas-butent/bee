 ...
 * @return 0 if values are equal, -1 if {@code oth} name value is greater,
 * 1 if the current Property name value is greater than {@code oth} name value.
 */
 ...
 */
  ...
  /**
   * @return a String representation of the current Property. Name and value are 
   * separated with a default value separator "=".
   * <p> E.g A Property with {@code Name} and {@code Value}
   * set would be represented as: {@code Name=Value}</p>
   */
  @Override
