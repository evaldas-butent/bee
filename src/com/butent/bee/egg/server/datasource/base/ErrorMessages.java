...
public class ErrorMessages extends ListResourceBundle {
  static final Object[][] CONTENTS = {
    ...
    {"CANNOT_GROUP_WITHOUT_AGG", "Cannot use GROUP BY when no aggregations are defined in SELECT."},
    {"CANNOT_PIVOT_WITHOUT_AGG", "Cannot use PIVOT when no aggregations are defined in SELECT."},
