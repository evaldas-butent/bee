...
public class ObjectFactory {
    ...
    private final static QName _GetSummarizedReport_QNAME = new QName("http://soap.wsbridge.ws.loctracker.msc/", "getSummarizedReport");
    private final static QName _GetSummarizedReportResponse_QNAME = new QName("http://soap.wsbridge.ws.loctracker.msc/", "getSummarizedReportResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: lt.locator
     * 
     */
