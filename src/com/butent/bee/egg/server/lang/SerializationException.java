...
public class SerializationException extends RuntimeException {
  ...
  /**
   * <p>
   * Constructs a new <code>SerializationException</code> with specified detail
   * message.
   * </p>
   * 
   * @param msg
  ...
  /**
   * <p>
   * Constructs a new <code>SerializationException</code> with specified nested
   * <code>Throwable</code>.
   * </p>
   * 
   * @param cause
   *          The <code>Exception</code> or <code>Error</code> that caused this
