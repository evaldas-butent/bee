package com.butent.bee.client.gwt;
...
import com.butent.bee.client.gwt.ResizeLayoutPanel.Impl.Delegate;
...
public class ResizeLayoutPanel extends SimplePanel implements ProvidesResize,
  ...
  abstract static class Impl {
     ...
     */
    public void init(Element elem, @SuppressWarnings("hiding") Delegate delegate) {
      this.parent = elem;
    ...
    private native void initResizeEventListener(Element elem) /*-{
      ...
      var handleResize = $entry(function() {
        if (theElem.__resizeImpl) {
          theElem.__resizeImpl.@com.butent.bee.client.gwt.ResizeLayoutPanel.Impl::handleResize()();
        }
      });
