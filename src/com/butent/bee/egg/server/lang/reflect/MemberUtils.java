...
abstract class MemberUtils {
   ...
   * Unfortunately, on some JVMs, using reflection to invoke these members seems
   * to (wrongly) to prevent access even when the modifer is public. Calling
   * setAccessible(true) solves the problem but will only work from sufficiently
