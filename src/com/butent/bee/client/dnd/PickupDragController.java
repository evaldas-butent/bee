...
import com.butent.bee.client.dnd.drop.BoundaryDropController;
import com.butent.bee.client.dnd.drop.DropController;
import com.butent.bee.client.dnd.util.CoordinateLocation;
...
public class PickupDragController extends AbstractDragController {
   ...
   * 
   * @param panel the panel to which our drag-and-drop operations are constrained
   ...
   */
  protected BoundaryDropController newBoundaryDropController(AbsolutePanel panel,
      boolean allowDroppingOnBoundaryPanel) {
    return new BoundaryDropController(panel, allowDroppingOnBoundaryPanel);
  }
   ...
   * drag proxies.
   * 
   * @param dragContext the current drag context
