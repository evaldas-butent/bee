 ...
 * @since 3.0
 * @version $Id: CharSequenceTranslator.java 967237 2010-07-23 20:08:57Z mbenson
 *          $
 */
public abstract class CharSequenceTranslator {
  ...
  public final String translate(CharSequence input) {
    ...
    try {
      StringWriter writer = new StringWriter(input.length() * 2); // TODO: Make
                                                                  // the 2 part
                                                                  // of the
                                                                  // API???
      ...
      if (consumed == 0) {
        ...
        for (int j = 0; j < consumed; j++) {
          if (i < sz - 2) {
            ...
            // If the String ends with a high surrogate, just add the 1 and
