...
public class WordUtils {
   ...
   *          the column to wrap the words at, less than 1 is treated as 1
   * @param newLineStr
   *          the string to insert for a new line, <code>null</code> uses the
   ...
   * defined by {@link Character#isWhitespace(char)}. A <code>null</code> input
   * String returns <code>null</code>. An empty delimiter array returns an empty
   * String.
   * </p>
   * 
   * <pre>
   ...
   * 
   * @param str
   *          the string to be abbreviated. If null is passed, null is returned.
   *          If the empty String is passed, the empty string is returned.
   * @param lower
   *          the lower limit.
   * @param upper
   *          the upper limit; specify -1 if no limit is desired. If the upper
   *          limit is lower than the lower limit, it will be adjusted to be the
   *          same as the lower limit.
   * @param appendToEnd
   *          String to be appended to the end of the abbreviated string. This
   *          is appended ONLY if the string was indeed abbreviated. The append
   *          does not count towards the lower or upper limits.
