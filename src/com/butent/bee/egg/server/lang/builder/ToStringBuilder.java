 ...
 * <pre>
 * System.out
 *     .println(&quot;An object: &quot; + ToStringBuilder.reflectionToString(anObject));
 * </pre>
 * 
 * <p>
...
public class ToStringBuilder implements Builder<String> {
  ...
  public static String reflectionToString(Object object, ToStringStyle style,
    ...
    return ReflectionToStringBuilder.toString(object, style, outputTransients,
        false, null);
  }
   ...
   * @since 2.0
   */
  public static <T> String reflectionToString(T object, ToStringStyle style,
      boolean outputTransients, Class<? super T> reflectUpToClass) {
    return ReflectionToStringBuilder.toString(object, style, outputTransients,
        false, reflectUpToClass);
  }
   ...
   * 
   * @param object
   *          the Object to build a <code>toString</code> for, not recommended
   *          to be null
   */
   ...
   *          to be null
   * @param style
   *          the style of the <code>toString</code> to create, null uses the
   *          default style
   */
   ...
   * <code>true</code> will output the array in full. Setting <code>false</code>
   * will output a summary, typically the size of the array.
   * </p>
   * 
   * @param fieldName
   *          the field name
   ...
   * its properties to another class. You can then call <code>toString()</code>
   * on the other class and pass the result into this method.
   * </p>
   * 
   * <pre>
