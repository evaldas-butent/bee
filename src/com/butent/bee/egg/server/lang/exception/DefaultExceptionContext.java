...
/**
 * Default implementation of the context storing the label-value pairs for
 * contexted exceptions.
 * <p>
 * This implementation is serializable, however this is dependent on the values
 * that are added also being serializable.
 * 
...
class DefaultExceptionContext implements ExceptionContext, Serializable {
   ...
   * label already exists and the provided information is different, the label
   * will be added with an appended index.
   * </p>
   * 
   * @param label
   *          the label of the item to add, null not recommended
   * @param value
      ...
      for (String label : contextValueMap.keySet()) {
        ...
        if (value == null) {
          ...
          try {
            ...
            valueStr = "Exception thrown on toString(): "
