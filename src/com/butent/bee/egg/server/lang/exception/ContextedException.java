 ...
 * with a map of context values. This additional information is automatically
 * included in the message and printed stack trace.
 * </p>
 * <p>
...
public class ContextedException extends Exception implements ExceptionContext {
   ...
   *          the underlying cause of the exception, may be null
   * @param context
   *          the context used to store the additional information, null uses
   ...
   * problem. For the information to be meaningful, the value passed should have
   * a reasonable toString() implementation. If the added label is already
   * available, the label is appended with an index.
   * <p>
   ...
   * 
   * @param label
   *          a textual label associated with information, null not recommended
   * @param value
   *          information needed to understand exception, may be null
   ...
   * the problem. For the information to be meaningful, the value passed should
   * have a reasonable toString() implementation. If the replaced label does not
   * yet exist, it is simply added.
   * <p>
   * Note: This exception is only serializable if the object added is
   * serializable.
   * </p>
