...
import com.butent.bee.egg.server.lang.ObjectUtils;
...
public abstract class ToStringStyle implements Serializable {
  ...
  /**
   * The default toString style. Using the Using the <code>Person</code> example
  ...
  /**
   * The no field names toString style. Using the Using the <code>Person</code>
   * example from {@link ToStringBuilder}, the output would look like this:
   * 
   * <pre>
  ...
  /**
   * The simple toString style. Using the Using the <code>Person</code> example
   * from {@link ToStringBuilder}, the output would look like this:
   * 
   * <pre>
   * John Doe,33,false
   ...
   * may request full detail (<code>true</code>), but a subclass might ignore
   * that and always return <code>false</code>. The calling code may pass in
   * <code>null</code> indicating that it doesn't care about the detail level.
   ...
   * 
   * <p>
   * This is an inner class rather than using <code>StandardToStringStyle</code>
  ...
  /**
   * <p>
   * <code>ToStringStyle</code> that does not print out the classname, identity
   * hashcode, content start or field name.
   * </p>
   * 
   * <p>
   * This is an inner class rather than using <code>StandardToStringStyle</code>
