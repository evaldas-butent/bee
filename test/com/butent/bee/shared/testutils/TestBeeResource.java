...
public class TestBeeResource {
  ...
  public final void testSerialize() {
    ...
    BeeResource resource =
        new BeeResource("http://localhost/image.jpg", "This will be an image", ContentType.IMAGE,
            true);
    assertEquals("0226http://localhost/image.jpg15IMAGE14true221This will be an image", resource
        .serialize());
