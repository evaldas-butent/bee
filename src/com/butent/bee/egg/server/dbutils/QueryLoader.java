...
public class QueryLoader {
   ...
   * 
   * @param path
   *          The path that the ClassLoader will use to find the file. This is
   *          <strong>not</strong> a file system path. If you had a jarred
   *          Queries.properties file in the com.yourcorp.app.jdbc package you
   *          would pass "/com/yourcorp/app/jdbc/Queries.properties" to this
   *          method.
   * @throws IOException
  ...
  /**
   * Loads a set of named queries into a Map object. This implementation reads a
   * properties file at the given path.
   * 
   * @param path
  ...
  protected Map<String, String> loadQueries(String path) throws IOException {
    // Findbugs flags getClass().getResource as a bad practice; maybe we should
    // change the API?
