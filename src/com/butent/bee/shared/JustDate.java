...
/**
 *  The class {@code JustDate} represents a specific instant in date, 
 *  with days precision. 
 */
public class JustDate extends AbstractDate implements BeeSerializable, Comparable<JustDate> {
	/**
	 * Default field of date separator to seperate {@code YYYY.MM.DD} format
	 */
  public static final char FIELD_SEPARATOR = '.';
  
  /**
   * Converts {@code String} to date format. If {@code s} is a number format, 
   * {@code s} converting  to days since January 1, 1970, otherwise pharse 
   * date fields seperated with seperators.
   * @param s string of days since January 1, 1970 or date seperated with seperators
  ...
  /**
   * Creates new {@code JustDate} object instance with day value since
   * January 1, 1970 
  ...
  /**
   *  Creates new {@code JustDate} object instance with year, mount and days
   *  values
   * @param year years
   * @param month mounth of year 1-12
  ...
  /**
   * Creates new {@code JustDate} object instance with milliseconds parameter 
   ...
   * @return 0 if dates are equals, less than 0 the {@code other} is for later date
   * and otherwise 
   */
  ...
  /**
   * Returns the value the day of week. The value returned between 1 and 7.
   * The first day of week are Sunday (value is 1).
  ...
  /**
   * Sets this {@code JustDate} object to represent a point in date that is 
   * {@code day} days after January 1, 1970.
