...
public class H6 extends FertileNode {
  ...
  public H6 setCSSClass(String value) {
  ...
  public H6 setTitle(String value) {
  ...
  public H6 setStyle(String value) {
  ...
  public H6 setLang(String value) {
