...
import com.butent.bee.egg.server.dbutils.BasicRowProcessor;
 ...
 * <code>ResultSet</code> into an <code>Object[]</code>. This class is thread
 * safe.
 * 
...
public class ArrayHandler implements ResultSetHandler<Object[]> {
  ...
  /**
   * Singleton processor instance that handlers share to save memory. Notice the
   * default scoping to allow only classes in this package to use this instance.
   */
