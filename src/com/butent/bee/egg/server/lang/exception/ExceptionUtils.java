 ...
 */
package com.butent.bee.egg.server.lang.exception;
...
public class ExceptionUtils {
  ...
  /**
   * <p>
   * Public constructor allows an instance of <code>ExceptionUtils</code> to be
   ...
   * 
   * <p>
   * From version 2.2, this method handles recursive cause structures that might
   * otherwise cause infinite loops. If the throwable parameter has a cause of
   * itself, then null will be returned. If the throwable parameter cause chain
   ...
   * <p>
   * From version 2.2, this method handles recursive cause structures that might
   * otherwise cause infinite loops. The cause chain is processed until the end
   * is reached, or until the next item in the chain is already in the result
   * set.
   * </p>
   * 
   * @param throwable
   ...
   * matches the specified class (exactly) in the exception chain. Subclasses of
   * the specified class do not match - see
   ...
   * <p>
   * Returns the (zero based) index of the first <code>Throwable</code> that
   * matches the specified class or subclass in the exception chain. Subclasses
   * of the specified class do match - see
   ...
   *          references
   * @return index of the <code>type</code> within throwables nested withing the
   ...
   * 
   * <p>
   * The output of this method is consistent across JDK versions. Note that this
   ...
   * 
   * <p>
   * The output of this method is consistent across JDK versions. It consists of
   * the root exception followed by each of its wrapping exceptions separated by
   * '[wrapped]'. Note that this is the opposite order to the JDK1.4 display.
   * </p>
   * 
   * @param throwable
   ...
   * Only the trace of the specified exception is returned, any caused by trace
   * is stripped.
   * </p>
   * 
   * <p>
