...
public class ClassUtils {
   ...
   *          <code>null</code>
   * @param autoboxing
   *          whether to use implicit autoboxing/unboxing between primitives and
   *          wrappers
   * @return <code>true</code> if assignment possible
   */
  public static boolean isAssignable(Class<?>[] classArray,
  ...
  /**
   * Returns the (initialized) class represented by <code>className</code> using
   * the <code>classLoader</code>. This implementation supports the syntaxes "
   * <code>java.util.Map.Entry[]</code>", "<code>java.util.Map$Entry[]</code>
   * ", "<code>[Ljava.util.Map.Entry;</code>", and "
   * <code>[Ljava.util.Map$Entry;</code>".
   * 
  ...
  /**
   * Returns the (initialized) class represented by <code>className</code> using
   * the current thread's context class loader. This implementation supports the
  ...
  public static Class<?> getClass(String className, boolean initialize)
    ...
    ClassLoader loader = contextCL == null ? ClassUtils.class.getClassLoader()
        : contextCL;
   ...
   * it ensures that the returned Method is from a public class or interface and
   * not from an anonymous inner class. This means that the Method is invokable
   * and doesn't fall foul of Java bug <a
   ...
   *           if the method is not found in the given class or if the metothod
   ...
   * <code>Class</code> objects. If any of these objects is null, a null element
