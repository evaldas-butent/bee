...
public class H3 extends FertileNode {
  ...
  public H3 setCSSClass(String value) {
  ...
  public H3 setTitle(String value) {
  ...
  public H3 setStyle(String value) {
  ...
  public H3 setLang(String value) {
