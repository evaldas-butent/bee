package com.butent.bee.egg.server.lang.math;

import java.math.BigDecimal;

import com.butent.bee.egg.server.lang.StringUtils;

public class NumberUtils extends
    com.butent.bee.egg.shared.lang.math.NumberUtils {
   ...
   * create successively larger types from the type specified until one is found
   ...
   * interpreted as a hexadecimal integer. Values with leading <code>0</code>'s
      ...
      case 'F':
        try {
          ...
          if (!(f.isInfinite() || (f.floatValue() == 0.0F && !allZeros))) {
            ...
            // has non-zeros in it, then float does not have the precision we
            // want
            return f;
          }
