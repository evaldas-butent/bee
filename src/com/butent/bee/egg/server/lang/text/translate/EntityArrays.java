 ...
 */
package com.butent.bee.egg.server.lang.text.translate;
 ...
 * @since 3.0
 * @version $Id: EntityArrays.java 967237 2010-07-23 20:08:57Z mbenson $
 */
public class EntityArrays {
  ...
  private static final String[][] ISO8859_1_ESCAPE = { { "\u00A0", "&nbsp;" }, // non-breaking
      ...
      { "\u00BE", "&frac34;" }, // vulgar fraction three quarters = fraction
                                // three quarters
  ...
  private static final String[][] HTML40_EXTENDED_ESCAPE = {
      ...
      { "\u0160", "&Scaron;" }, // -- latin capital letter S with caron,U+0160
                                // ISOlat2 -->
      { "\u0161", "&scaron;" }, // -- latin small letter s with caron,U+0161
                                // ISOlat2 -->
      { "\u0178", "&Yuml;" }, // -- latin capital letter Y with diaeresis,U+0178
                              // ISOlat2 -->
      // <!-- Spacing Modifier Letters -->
      { "\u02C6", "&circ;" }, // -- modifier letter circumflex accent,U+02C6
                              // ISOpub -->
