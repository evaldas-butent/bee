 ...
 * the License.
 */
package com.butent.bee.client.dnd.util.impl;
...
public abstract class DOMUtilImpl {
  ...
  public native String getEffectiveStyle(Element elem, String style) /*-{
    return this.@com.butent.bee.client.dnd.util.impl.DOMUtilImpl::getComputedStyle(Lcom/google/gwt/dom/client/Element;Ljava/lang/String;)(elem,style)
