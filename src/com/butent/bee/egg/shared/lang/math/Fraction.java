 ...
 */
package com.butent.bee.egg.shared.lang.math;
 ...
 * @since 2.0
 * @version $Id: Fraction.java 889215 2009-12-10 11:56:38Z bayard $
 */
public final class Fraction extends Number implements Comparable<Fraction> {
  ...
  /**
   * <p>
   * Constructs a <code>Fraction</code> instance with the 2 parts of a fraction
   * Y/Z.
   * </p>
   * 
   * @param numerator
  ...
  /**
   * <p>
   * Gets the fraction as a <code>float</code>. This calculates the fraction as
  ...
  /**
   * <p>
   * Gets the fraction as a <code>double</code>. This calculates the fraction as
   * the numerator divided by denominator.
   * </p>
   * 
   ...
   *         power is zero (even if the fraction equals ZERO) or a new fraction
   *         instance raised to the appropriate power
   * @throws ArithmeticException
  ...
  private static int greatestCommonDivisor(int u, int v) {
    ...
    // B1. [Find power of 2]
    int k = 0;
    while ((u & 1) == 0 && (v & 1) == 0 && k < 31) { // while u and v are both
                                                     // even...
      u /= 2;
      v /= 2;
      k++; // cast out twos.
   ...
   *           if the fraction is <code>null</code>
   * @throws ArithmeticException
   *           if the resulting numerator or denominator cannot be represented
   *           in an <code>int</code>.
   */
  ...
  public boolean equals(Object obj) {
    ...
    return (getNumerator() == other.getNumerator() && getDenominator() == other
        .getDenominator());
  }
