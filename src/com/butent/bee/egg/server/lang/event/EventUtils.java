...
import com.butent.bee.egg.server.lang.reflect.MethodUtils;
...
public class EventUtils {
  ...
  public static <L> void addEventListener(Object eventSource,
      Class<L> listenerType, L listener) {
    try {
      MethodUtils.invokeMethod(eventSource,
          "add" + listenerType.getSimpleName(), listener);
   ...
   */
  public static <L> void bindEventsToMethod(Object target, String methodName,
      Object eventSource, Class<L> listenerType, String... eventTypes) {
    final L listener = listenerType.cast(Proxy.newProxyInstance(target
  ...
  private static class EventBindingInvocationHandler implements
    ...
    public EventBindingInvocationHandler(final Object target,
        final String methodName, String[] eventTypes) {
      this.target = target;
