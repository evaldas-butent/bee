 ...
 * Naming patterns are <em>format strings</em> as used by the
 * {@code String.format()} method. The string can contain the place holder
 * {@code %d} which will be replaced by the number of the current thread (
 * {@code ThreadFactoryImpl} keeps a counter of the threads it has already
 * created). For instance, the naming pattern {@code "My %d. worker thread"}
 * will result in thread names like {@code "My 1. worker thread"},
 * {@code "My 2. worker thread"} and so on.</li>
...
public class BasicThreadFactory implements ThreadFactory {
  ...
  /**
   * <p>
   * A <em>builder</em> class for creating instances of
  ...
  public static class Builder implements
      com.butent.bee.egg.server.lang.builder.Builder<BasicThreadFactory> {
    ...
    /**
     * Sets the {@code ThreadFactory} to be wrapped by the new
     * {@code BasicThreadFactory}.
     * 
     * @param factory
