...
/**
 * The class DateTime represents a specific instant in time, with 
...
public class DateTime extends AbstractDate implements BeeSerializable, Comparable<DateTime> {
  ...
  /**
   * Separator for fields of time seperate to format hh.mm.ss 
   */
  public static final char TIME_FIELD_SEPARATOR = ':';
  
  /**
   * Separator for field of milliseconds seperate
   */
  public static final char MILLIS_SEPARATOR = '.';
  
  /**
   * Parsing {@code String s} to date format. If the {@code s} a number expression 
   * is converted to a milliseconds. Otherwise pharses of string an year, mounth,
   * day, hours, minutes and seconds between separators. The time fields are not 
   * necessary.     
  ...
  /**
   * Creates a new object of {@code DateTime} with date parrameters
   * @param year the year
   * @param month the mounthh between 1-12
   * @param dom the day of mounthh between 1-31
   */
  ...
  /**
   * Creates a new object of {@code DateTime} with date and times parameters
   ...
   * @param time time of milliseconds scine 00:00:00 GMT on January 1, 1970
   */
  ...
  /**
   * Comapares two {@code DateTime} objects by date and time values
   * @param other the {@code DateTime} to be compared
   * @return 0 the {@code DateTime} values of object are equals,
   * more than 0 the {@code other} values are greater,
   * less than 0 the (@code other} values are lower.  
   */
  ...
  /**
   * Returns the number day of mounth representing this object. The value returned
   * between 1 and 31.
   * @return the number day of mounth representing this object.
   */
  public int getDom() {
    ensureFields();
  ...
  /**
   * Returns the number day of week representing this object. The value returned
   * 1 and 7. First day of week Sunday (value 1)
  ...
  /**
   * Returns the number day of year representing this object. The value returned
   * between 1 and 366
  ...
  /**
   * Returns the number of hour represented this object. The value returned between
   * 0 and 23;
  ...
  /**
   * Returns the number of miliseconds the past of second. The value returned 
   * between 0 and 999.
  ...
  /**
   * Returns the number of minutes the past of hour. The value returned between 
   * 0 and 59.
   ...
   * relative to UTC that is appropriate for the time represented by this DateTime 
   * object. 
  ...
  /**
   * Returns the number the day of mounth by UTC time. The value returned between 1 and
   * 31.
  ...
  /**
   * Returns the number the day of week by UTC time. The value returned between 1 and 7.
   * First day of week Sunday (value equals 1).
  ...
  /**
   * Returns the number the day of year by UTC time. The value returned between
   * 1 and 366
  ...
  /**
   * Returns the number of hour of this object by UTC time. The value returned 
   * between 0 and 23.
  ...
  /**
   * Returns the number of minutes by UTC time. The value returned between 
   * 0 and 59
  ...
  /**
   * Returns a number representing the mounth by UTC time. The value returned
   * between 1 and 12.
  ...
  /**
   * Returns a number of seconds the past minute by UTC time. The value returned
   * between 0 and 59.
