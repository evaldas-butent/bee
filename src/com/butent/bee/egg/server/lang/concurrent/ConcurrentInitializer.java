...
public interface ConcurrentInitializer<T> {
   ...
   * {@code ConcurrentInitializer}. A concrete implementation here returns the
   * results of the initialization process. This method may block until results
   * are available. Typically, once created the result object is always the
   * same.
   * 
