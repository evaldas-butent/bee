 ...
 * @author Matt Benson
 * @since 2.5
 * @version $Id: MethodUtils.java 925961 2010-03-22 05:59:31Z bayard $
 */
public class MethodUtils {
  ...
  public static Object invokeMethod(Object object, String methodName,
    ...
    Method method = getMatchingAccessibleMethod(object.getClass(), methodName,
        parameterTypes);
    if (method == null) {
   ...
   * <p>
   * This method supports calls to methods taking primitive parameters via
   * passing in wrapping classes. So, for example, a <code>Boolean</code> class
   * would match a <code>boolean</code> primitive.
   * </p>
   * 
   * <p>
   ...
   * return <code>null</code>. This is just a convenient wrapper for
