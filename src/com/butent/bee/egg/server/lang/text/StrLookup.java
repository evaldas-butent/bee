 ...
 * @since 2.2
 * @version $Id: StrLookup.java 899933 2010-01-16 12:53:54Z sebb $
 */
public abstract class StrLookup<V> {
  ...
  static {
    ...
    try {
      ...
      // System property keys and values are always Strings
   ...
   * as a primary key, and looked up the value on demand from the database Or, a
