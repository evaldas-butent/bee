...
public abstract class LazyInitializer<T> implements ConcurrentInitializer<T> {
  ...
  /**
   * Returns the object wrapped by this instance. On first access the object is
   * created. After that it is cached and can be accessed pretty fast.
   * 
  ...
  /**
   * Creates and initializes the object managed by this {@code LazyInitializer}.
   * This method is called by {@link #get()} when the object is accessed for the
   * first time. An implementation can focus on the creation of the object. No
