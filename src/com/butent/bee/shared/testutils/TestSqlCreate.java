...
public class TestSqlCreate {
	...
	public final void testSqlCreate(){
		...
		assertEquals("CREATE TEMPORARY TABLE Target (arIvykdyta BIT SET NULL)", create.getSqlString(builder, false));
		...
		create.getSqlString(builder, false);
		assertEquals("CREATE TABLE [Target] ([arIvykdyta] BIT SET NULL, [field2] INTEGER)", create.getSqlString(builder, false));
		...
		create.addField("field2", DataType.INTEGER , 5 , 6);
		create.getSqlString(builder, false);
		assertEquals("CREATE TEMPORARY TABLE `Target` (`arIvykdyta` BIT SET NULL, `field2` INTEGER) ENGINE=InnoDB", create.getSqlString(builder, false));
        ...
        assertEquals("CREATE TEMPORARY TABLE Target AS SELECT Table1.field1, Table1.field2 FROM Table1", create2.getSqlString(builder2, false));
        ...
        assertEquals("CREATE TEMPORARY TABLE Target (boolean field BIT SET NULL, char CHAR(25) NOT NULL, data INTEGER, datetime BIGINT, double value DOUBLE, int field INTEGER NOT NULL, long field BIGINT, numeric field NUMERIC(10, 10), string field VARCHAR(7))", create3.getSqlString(builder3, false));
		...
		create.addDate("data");
		create.getSqlString(builder, false);
		assertEquals("CREATE TEMPORARY TABLE \"Target\" (\"arIvykdyta\" NUMERIC(1) SET NULL, \"kaina\" DOUBLE PRECISION, \"data\" INTEGER)", create.getSqlString(builder, false));
		...
		create.getSqlString(builder, false);
		assertEquals("CREATE TABLE \"Target\" (\"arIvykdyta\" NUMERIC(1) SET NULL, \"kaina\" BINARY_DOUBLE, \"data\" NUMERIC(10), \"kiek\" NUMERIC(10), \"millis\" NUMERIC(19), \"dateTime\" NUMERIC(19), \"pav\" NVARCHAR2(10), \"char field\" CHAR(2))", create.getSqlString(builder, false));  
	}
	...
	public final void testSqlCreateDataSource(){        
        ...
        assertEquals("CREATE TEMPORARY TABLE Target (boolean field BIT SET NULL, data INTEGER, datetime BIGINT, double value DOUBLE, long field BIGINT, numeric field NUMERIC(10, 10), string field VARCHAR(7))", create4.getSqlString(builder4, false));
