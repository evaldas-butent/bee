...
import com.butent.bee.egg.shared.lang.math.NumberUtils;
 ...
 * @author Gary Gregory
 * @since 2.0
 * @version $Id: BooleanUtils.java 966173 2010-07-21 10:51:50Z sebb $
 */
public class BooleanUtils {
   ...
   * <code>BooleanUtils.negate(true);</code>.
   * </p>
   * 
   * <p>
   ...
   * @return <code>true</code> or <code>false</code>, <code>null</code> returns
   *         <code>false</code>
   */
  ...
  /**
   * <p>
   * Converts an int to a boolean using the convention that <code>zero</code> is
   * <code>false</code>.
   * </p>
   * 
   * <pre>
   ...
   * @param value
   *          the int to convert
   * @return Boolean.TRUE if non-zero, Boolean.FALSE if zero, <code>null</code>
   *         if <code>null</code>
   */
   ...
   *          the Integer to convert
   * @param trueValue
   *          the value to match for <code>true</code>, may be <code>null</code>
   * @param falseValue
  ...
  /**
   * <p>
   * Converts a boolean to an int using the convention that <code>zero</code> is
   * <code>false</code>.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Converts a Boolean to a Integer using the convention that <code>zero</code>
   * is <code>false</code>.
   * </p>
   * 
   * <p>
   ...
   *          the to convert
   * @param trueValue
   *          the value to return if <code>true</code>, may be <code>null</code>
   * @param falseValue
   ...
   *          <code>null</code>
   * @param nullValue
   *          the value to return if <code>null</code>, may be <code>null</code>
   * @return the appropriate value
   */
  public static Integer toIntegerObject(Boolean bool, Integer trueValue,
      Integer falseValue, Integer nullValue) {
   ...
   *          the String to check
   * @param trueString
   *          the String to match for <code>true</code> (case sensitive), may be
   *          <code>null</code>
   * @param falseString
   *          the String to match for <code>false</code> (case sensitive), may
   *          be <code>null</code>
   * @param nullString
   *          the String to match for <code>null</code> (case sensitive), may be
   *          <code>null</code>
   ...
   * @param str
   *          the String to check
   * @return the boolean value of the string, <code>false</code> if no match or
   *         the String is null
   */
