...
public class LocalProvider extends CachedProvider {
  ...
  public LocalProvider(HasDataTable display, HasDataProvider presenter,
    ...
    this(display, presenter, notificationListener, viewName, columns, null, table, null, null);
  }
  ...
  public LocalProvider(HasDataTable display, HasDataProvider presenter,
    ...
    super(display, presenter, notificationListener, viewName, columns, immutableFilter, table,
