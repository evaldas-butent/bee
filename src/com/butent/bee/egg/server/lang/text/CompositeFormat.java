 ...
 * @version $Id: CompositeFormat.java 889215 2009-12-10 11:56:38Z bayard $
 */
public class CompositeFormat extends Format {
   ...
   *          the String source
   * @param pos
   *          the ParsePosition containing the position to parse from, will be
   *          updated according to parsing success (index) or failure (error
   *          index)
