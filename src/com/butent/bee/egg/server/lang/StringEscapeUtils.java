...
import com.butent.bee.egg.server.lang.text.translate.AggregateTranslator;
import com.butent.bee.egg.server.lang.text.translate.CharSequenceTranslator;
import com.butent.bee.egg.server.lang.text.translate.EntityArrays;
import com.butent.bee.egg.server.lang.text.translate.LookupTranslator;
import com.butent.bee.egg.server.lang.text.translate.NumericEntityUnescaper;
import com.butent.bee.egg.server.lang.text.translate.UnicodeEscaper;
import com.butent.bee.egg.server.lang.text.translate.UnicodeUnescaper;
import com.butent.bee.egg.shared.lang.CharUtils;

/**
 * <p>
 * Escapes and unescapes <code>String</code>s for Java, Java Script, HTML and
 * XML.
 * </p>
 * 
 * <p>
...
public class StringEscapeUtils {
  ...
  public static final CharSequenceTranslator ESCAPE_ECMASCRIPT = new AggregateTranslator(
      new LookupTranslator(new String[][] { { "'", "\\'" }, { "\"", "\\\"" },
          ...
          EntityArrays.JAVA_CTRL_CHARS_ESCAPE()), UnicodeEscaper.outsideOf(32,
          0x7f));
  ...
  static class CsvEscaper extends CharSequenceTranslator {
    ...
    // TODO: Replace with a RegexTranslator. That should consume the number of
    // characters the regex uses up?
    @Override
  ...
  public static final CharSequenceTranslator UNESCAPE_JAVA = new AggregateTranslator(
      new UnicodeUnescaper(), new LookupTranslator(
          EntityArrays.JAVA_CTRL_CHARS_UNESCAPE()), new LookupTranslator(
          new String[][] { { "\\\\", "\\" }, { "\\\"", "\"" }, { "\\'", "'" },
              { "\\", "" } }));
  ...
  static class CsvUnescaper extends CharSequenceTranslator {
    ...
    public int translate(CharSequence input, int index, Writer out)
      ...
      if (StringUtils.containsAny(quoteless, CSV_SEARCH_CHARS)) {
        ...
        out.write(StringUtils.replace(quoteless, CSV_QUOTE_STR + CSV_QUOTE_STR,
            CSV_QUOTE_STR));
      } else {
        out.write(input.toString());
      }
  ...
  /**
   * <p>
   * Escapes the characters in a <code>String</code> using EcmaScript String
   * rules.
   * </p>
   * <p>
  ...
  /**
   * <p>
   * Unescapes any EcmaScript literals found in the <code>String</code>.
   * </p>
   * 
   * <p>
   ...
   *         comma, newline or double quote, <code>null</code> if null string
   *         input
   * @since 2.4
   */
   ...
   *         double quotes unescaped, <code>null</code> if null string input
   * @since 2.4
   */
