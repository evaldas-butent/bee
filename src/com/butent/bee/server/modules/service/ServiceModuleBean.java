...
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_CRITERIA_GROUP;
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_CRITERIA_GROUP_NAME;
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_CRITERIA_ORDINAL;
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_CRITERION_NAME;
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_CRITERION_VALUE;
import static com.butent.bee.shared.modules.documents.DocumentConstants.COL_DOCUMENT_DATA;
import static com.butent.bee.shared.modules.documents.DocumentConstants.TBL_CRITERIA;
import static com.butent.bee.shared.modules.documents.DocumentConstants.TBL_CRITERIA_GROUPS;
import static com.butent.bee.shared.modules.documents.DocumentConstants.TBL_DOCUMENT_TREE;
import static com.butent.bee.shared.modules.service.ServiceConstants.ALS_SERVICE_CATEGORY_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.ALS_SERVICE_CONTRACTOR_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.ALS_SERVICE_CUSTOMER_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_DEFECT;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_DEFECT_ITEM;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_DEFECT_NOTE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_MAINTENANCE_DATE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_MAINTENANCE_DEFECT;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_MAINTENANCE_INVOICE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_MAINTENANCE_ITEM;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_MAINTENANCE_NOTES;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_OBJECT_STATUS;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_ADDRESS;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CALENDAR_MAX_DATE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CALENDAR_MIN_DATE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CALENDAR_TASK_TYPES;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CATEGORY;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CATEGORY_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CONTRACTOR;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CRITERIA_GROUP;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CRITERIA_GROUP_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CRITERIA_ORDINAL;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CRITERION_NAME;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CRITERION_VALUE;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_CUSTOMER;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_DATE_FROM;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_DATE_UNTIL;
import static com.butent.bee.shared.modules.service.ServiceConstants.COL_SERVICE_OBJECT;
import static com.butent.bee.shared.modules.service.ServiceConstants.PRM_SVC_POTENTIAL_OBJECT_CATEGORY;
import static com.butent.bee.shared.modules.service.ServiceConstants.PRM_SVC_PROJECT_OBJECT_CATEGORY;
import static com.butent.bee.shared.modules.service.ServiceConstants.PRM_SVC_SERVICE_OBJECT_CATEGORY;
import static com.butent.bee.shared.modules.service.ServiceConstants.PROP_CRITERIA;
import static com.butent.bee.shared.modules.service.ServiceConstants.PROP_MAIN_ITEM;
import static com.butent.bee.shared.modules.service.ServiceConstants.SVC_COPY_DOCUMENT_CRITERIA;
import static com.butent.bee.shared.modules.service.ServiceConstants.SVC_CREATE_DEFECT_ITEMS;
import static com.butent.bee.shared.modules.service.ServiceConstants.SVC_CREATE_INVOICE_ITEMS;
import static com.butent.bee.shared.modules.service.ServiceConstants.SVC_GET_CALENDAR_DATA;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_MAINTENANCE;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_CRITERIA;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_CRITERIA_GROUPS;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_DATES;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_DEFECT_ITEMS;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_OBJECTS;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_SETTINGS;
import static com.butent.bee.shared.modules.service.ServiceConstants.TBL_SERVICE_TREE;
import static com.butent.bee.shared.modules.service.ServiceConstants.VAR_SERVICE_FILTER_DATA;
import static com.butent.bee.shared.modules.service.ServiceConstants.VAR_SERVICE_OBJECT_STATUS;
...
import static com.butent.bee.shared.modules.service.ServiceConstants.VIEW_SERVICE_OBJECTS;
import static com.butent.bee.shared.modules.service.ServiceConstants.VIEW_SERVICE_OBJECT_CRITERIA;
import static com.butent.bee.shared.modules.service.ServiceConstants.VIEW_SERVICE_SETTINGS;
import static com.butent.bee.shared.modules.tasks.TaskConstants.ALS_LAST_SPAWN;
import static com.butent.bee.shared.modules.tasks.TaskConstants.ALS_TASK_TYPE_BACKGROUND;
import static com.butent.bee.shared.modules.tasks.TaskConstants.ALS_TASK_TYPE_FOREGROUND;
...
import static com.butent.bee.shared.modules.tasks.TaskConstants.COL_RECURRING_TASK;
import static com.butent.bee.shared.modules.tasks.TaskConstants.COL_RT_SCHEDULE_FROM;
import static com.butent.bee.shared.modules.tasks.TaskConstants.COL_RT_SCHEDULE_UNTIL;
import static com.butent.bee.shared.modules.tasks.TaskConstants.COL_STAR;
...
import static com.butent.bee.shared.modules.tasks.TaskConstants.COL_TASK_TYPE_NAME;
import static com.butent.bee.shared.modules.tasks.TaskConstants.TBL_RECURRING_TASKS;
import static com.butent.bee.shared.modules.tasks.TaskConstants.TBL_TASKS;
import static com.butent.bee.shared.modules.tasks.TaskConstants.TBL_TASK_TYPES;
import static com.butent.bee.shared.modules.tasks.TaskConstants.TBL_TASK_USERS;
import static com.butent.bee.shared.modules.tasks.TaskConstants.VIEW_RT_DATES;
