 ...
 * <em>not</em> be used with the <a
 * href="http://code.google.com/webtoolkit/">Google Web Toolkit</a> (GWT), even
 * though its type is annotated as {@link GwtCompatible} and accessible in GWT.
 * They can cause GWT compilation errors or simply unexpected exceptions when
 * used in GWT.
 * 
 * <p>
