...
public abstract class RectangularShape {
  ...
  /**
   * Returns the smallest X coordinate of the framing rectangle of the <code>Shape</code> in
   * <code>double</code> precision.
   * 
  ...
  /**
   * Returns the smallest Y coordinate of the framing rectangle of the <code>Shape</code> in
   * <code>double</code> precision.
   * 
  ...
  /**
   * Returns the largest X coordinate of the framing rectangle of the <code>Shape</code> in
   * <code>double</code> precision.
   * 
  ...
  /**
   * Returns the largest Y coordinate of the framing rectangle of the <code>Shape</code> in
   * <code>double</code> precision.
   * 
   ...
   * 
   * @return a <code>Rectangle2D</code>, specified in <code>double</code> coordinates.
   ...
   * 
   * @return <code>true</code> if the <code>RectangularShape</code> is empty; <code>false</code>
   *         otherwise.
   * @since 1.2
   */
   ...
   * <code>Rectangle2D</code>. The framing rectangle is used by the subclasses of
   ...
   * specified coordinates. The framing rectangle is used by the subclasses of
   * <code>RectangularShape</code> to define their geometry.
   *
  ...
  /**
   * Sets the diagonal of the framing rectangle of this <code>Shape</code> based on two specified
   * <code>Point2D</code> objects. The framing rectangle is used by the subclasses of
   * <code>RectangularShape</code> to define their geometry.
   *
  ...
  /**
   * Sets the framing rectangle of this <code>Shape</code> based on a specified center
   * <code>Point2D</code> and corner <code>Point2D</code>. The framing rectangle is used by the
