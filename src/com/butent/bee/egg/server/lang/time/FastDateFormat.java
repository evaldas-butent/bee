...
public class FastDateFormat extends Format {
  ...
  private interface Rule {
    ...
    /**
     * Appends the value of the specified calendar to the output buffer based on
  ...
  private static class CharacterLiteral implements Rule {
    ...
    /**
     * Constructs a new instance of <code>CharacterLiteral</code> to hold the
     * specified value.
     * 
     * @param value
  ...
  private static class TextField implements Rule {
    ...
    /**
     * Constructs an instance of <code>TextField</code> with the specified field
     * and values.
     * 
     * @param field
     *          the field
    ...
    public final void appendTo(StringBuffer buffer, int value) {
      if (value < 100) {
        ...
        if (value < 1000) {
          ...
          Validate.isTrue(value > -1, "Negative values should not be possible",
              value);
  ...
  private static class TimeZoneNameRule implements Rule {
     ...
     *          if <code>true</code> the time zone is forced into standard and
     *          daylight
     * @param locale
     *          the locale
     * @param style
     *          the style
     */
    TimeZoneNameRule(TimeZone timeZone, boolean timeZoneForced, Locale locale,
        int style) {
      mTimeZone = timeZone;
  ...
  private static class TimeZoneNumberRule implements Rule {
     ...
     * 
     * @param colon
     *          add colon between HH and MM in the output if <code>true</code>
     */
  ...
  private static class TimeZoneDisplayKey {
     ...
     *          the time zone
     * @param daylight
     *          adjust the style for daylight saving time if <code>true</code>
     * @param style
     *          the timezone style
     * @param locale
     *          the timezone locale
