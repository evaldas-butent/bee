 ...
 * @since 1.0
 * @version $Id: ObjectUtils.java 960138 2010-07-03 00:30:46Z joehni $
 */
// @Immutable
public class ObjectUtils {
  ...
  /**
   * <p>
   * Returns the first value in the array which is not <code>null</code>. If all
   * the values are <code>null</code> or the array is <code>null</code> or empty
  ...
  public static class Null implements Serializable {
    /**
     * Required for serialization support. Declare serialization compatibility
     * with Commons Lang 1.0
     * 
