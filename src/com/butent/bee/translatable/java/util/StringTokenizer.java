...
public class StringTokenizer implements Enumeration<Object> {
   ...
   * <code>false</code>, the delimiter characters are skipped and only serve as separators between
   * tokens.
   * <p>
   * Note that if <tt>delim</tt> is <tt>null</tt>, this constructor does not throw an exception.
   * However, trying to invoke other methods on the resulting <tt>StringTokenizer</tt> may result in
  ...
  public boolean hasMoreTokens() {
    /*
     * Temporarily store this position and use it in the following nextToken() method only if the
  ...
  public String nextToken() {
    /*
     * If next position already computed in hasMoreElements() and delimiters have changed between
